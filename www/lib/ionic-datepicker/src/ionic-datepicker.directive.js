  ...
  function IonicDatepicker($ionicPopup, $ionicModal, IonicDatepickerService) {
    return {
      ...
      link: function (scope, element, attrs) {
        ...
        scope.closeLabel = scope.inputObj.closeLabel ? (scope.inputObj.closeLabel) : 'Cerrar';
        ...
        scope.monthsList = ['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre'];
